...
edit_button = tk.Button(header, text="Duzenle", bg="gray", fg="white",padx=10, font=("Arial", 12, "bold"),command=lambda : openEditMovie(root,selectedMovie,saveFn=add_movie,fetchFn=fetchMovies))
